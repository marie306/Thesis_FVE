...
3. **BPEJ** – shoda na úrovni HPJ (první dvě číslice BPEJ) případně shoda v půdním typu-již načteno jako vrstva v QGIS - uvidím, co bude sedět lépe (co mi budvyřazovat méně ploch) a podle toho se rozhodnu 
